...
!!! warning "软件版权说明"
    ModelSim 是 Siemens EDA 的商业软件。本节提供的安装包**仅供本课程教学与个人学习使用**，
    请勿用于任何商业用途，也请勿将下载链接或安装包转发至课程范围之外。课程结束后请自行卸载。

    所在单位已有正版授权的同学，请优先使用正版授权。
...
安装步骤写在压缩包内的说明文件里，按其操作即可，安装路径为 `D:\modeltech64_2019.2`。
